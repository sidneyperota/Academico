  ...
  <body class="text-center">
    ...
    <div class="cover-container d-flex w-110 h-120 p-5 mx-auto flex-column">
      ...
      <div class="card-body">
        ...
        <div class="card-header"> Caixa Fácil Aplicativo Web Versão 1.0 </div>


          <div class="card-body">
            <h5 class="card-title"> Novo Caixa </h5>
            <p class="card-text"> O Caixa atual foi liberado, para realizar um lançamento é necessário criar o próximo caixa </p>
            <p class="card-text"> Informe a data para criar o próximo caixa.</p>

          <form method="post" action="">
            <div class="form-group">
            <label for="data"> Digite a data do Caixa:</label>
            <strong> 
...
<?php
  ...
  { 
    ...
    // Iniciar SESSAO 
    session_start();
    $iCodUsuario = $_SESSION['idUsuario'];
